  ...
  },
  {
    ...
    body: (
      <p>
        ...
        into industrial wipers — with audited numbers behind it, not a
        marketing claim.
      </p>
    ),
  },
    ...
    <CaseStudyLayout>
      ...
      <CaseStudySection index="04" heading="The reframe">
        ...
        <p>
          ...
          spreadsheet reorder cycle with a real tool — the company converts more
          first-time buyers and keeps more of the repeat ones.
        </p>
      </CaseStudySection>
